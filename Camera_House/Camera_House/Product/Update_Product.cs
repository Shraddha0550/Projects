...
namespace Camera_House
{
    public partial class Update_Product : Form
    {
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            if (tb_Prod_ID.Text != "")
            {
                SqlDataAdapter sda = new SqlDataAdapter("Update Add_New_Product Set Purches_Price = " + tb_Purches_Price.Text + ",Sale_Price = " + tb_Sale_Price.Text + ", Discription = '" + tb_Description.Text + "' Where Prod_ID = " + tb_Prod_ID.Text + " ", CF.Con);
