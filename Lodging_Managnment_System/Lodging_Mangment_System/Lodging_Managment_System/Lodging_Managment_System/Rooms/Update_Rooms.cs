...
namespace Lodging_Managment_System
{
    public partial class Update_Rooms : Form
    {
        ...
        private void tb_Room_No_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void tb_Amount_Day_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!((char.IsDigit(e.KeyChar)) || (e.KeyChar == (char)Keys.Back)))
            {
                e.Handled = true;
        ...
        private void tb_Per_Hrs_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!((char.IsDigit(e.KeyChar)) || (e.KeyChar == (char)Keys.Back)))
            {
                e.Handled = true;
