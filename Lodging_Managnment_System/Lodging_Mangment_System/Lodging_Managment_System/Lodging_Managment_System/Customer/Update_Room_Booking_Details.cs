    ...
    public partial class Update_Room_Booking_Details : Form
    {
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (obj12.Read())
                {
                    ...
                    if (tb_Day.Text == "0")
                    {
                        tb_Day.Enabled = false;
                    }
                    else
                    {
                        tb_Hrs.Enabled = false;
                        tb_Day.Enabled = false;
                    }
        ...
        private void btn_Total_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    tb_Total.Text = (Convert.ToInt32(tb_Hrs.Text) * Convert.ToDecimal(tb_Amount.Text)).ToString();
                }
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlDataAdapter s = new SqlDataAdapter("Update Pay_Amount Set Room_Bill = " + tb_Total.Text + " ,Total = " + tb_Bill.Text + " , Remaining = " + tb_Remaining.Text + " , Update_Username = '" + UserName_Updt + "' where Cust_ID = " + tb_Cust_ID.Text + " ", Con);
